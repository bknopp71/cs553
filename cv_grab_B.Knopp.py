...
def pick_up(x, y, theta):
    ...
    # off_set_z_pick = 0.36
    # new_cart = sdk.movement.position.get_arm_position()
    # new_cart_z = new_cart.get_position_info()
    res = sdk.movement.position.get_arm_position()
    dat = res.ok()
    # pos_z = dat.tooltip_position.position.rz
    orien_x = dat.tooltip_position.orientation.quaternion.x
    orien_y = dat.tooltip_position.orientation.quaternion.y  
    orien_z = dat.tooltip_position.orientation.quaternion.z
    orien_w = dat.tooltip_position.orientation.quaternion.w 

    # print("pos pos_z", pos_z)
    print("orient z", x)
    print("orient z", y)
    print("orient z", above_z)
    print("orient z", orien_x)
    print("orient z", orien_y)
    print("orient z", orien_z)
    print("orient z", orien_w)
